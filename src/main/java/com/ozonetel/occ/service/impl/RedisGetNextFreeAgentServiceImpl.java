 ...
 * @author pavanj
 */
public class RedisGetNextFreeAgentServiceImpl implements RedisGetNextFreeAgentService {
    ...
    public String getNextFreeAgent(String username, String campaignId, String did, String callerId, String ucid, String agentMonitorUcid, String skillName, String agentId, String agentPh) {
        ...
        log.info("----------Executing redis getnextfree agent");
        ...
        try {
            ...
            if (StringUtils.isBlank(campaignId)) {
                campaignId = redisCampaignManager.getString("inbound:did:" + did);
            }
            ...
            Skill tmpSkill = redisSkillManager.get(username + ":skills", "skill:" + tmpSkillId);

            log.trace("Temp skill:" + tmpSkill+" | "+tmpSkill);
            ...
            synchronized (this) {
                ...
                //--- >If queue is not empty for the skill,check this call position in the queue.
                //     If the call is on top proceed checking for the free agent, otherwise return.
...
//                            int counter=0;
                            for (Map.Entry<Double, String> tmpAgentEntry : agentSortedMap.entrySet()) {
                                ...
                                /*
                                 ...
                                 tmpQueueKeys = new HashSet<>(agentSkills.size());
                            ...
                            if (freeAgent != null) {
                                ...
                                //Commented as we are not using agent.user
...
//                    }
    ...
    public static void setLog(Logger log) {
        RedisGetNextFreeAgentServiceImpl.log = log;
    }
    //
    // ----- > Redis managers
    ...
    private static Logger log = Logger.getLogger(RedisGetNextFreeAgentServiceImpl.class);
}
