 ...
 * @author pavanj
 */
public class BlindPhoneTransferCommand extends AbstractAgentToolbarCommand<AgentCommandStatus> {

    public BlindPhoneTransferCommand(String username, String agentId, Long monitorUcid, Long ucid, String did, Long transferNumberId, String transferNumberName, String receiverPhoneNumber, String custNumber, PhoneTransferManager phoneTransferManager, String appAudioURL) {
...
//-------------------------------------        
        return new AgentCommandStatus(phoneTransferManager.blindTransfer(username, agentId, monitorUcid, ucid, did, transferNumberId, transferNumberName, receiverPhone, custNumber, appAudioURL));
    }
