 ...
 * @author pavanj
 */
public class BlindAgentTransferCommand extends AbstractAgentToolbarCommand<AgentCommandStatus> {

    public BlindAgentTransferCommand(String username, String agentId, Long monitorUcid, Long ucid, String did, String receiverAgentId, String custNumber, AgentTransferManager agentTransferManager, String appAudioURL) {
...
//-------------------------------------        
        return new AgentCommandStatus(agentTransferManager.blindTransfer(username, agentId, monitorUcid, ucid, did, receiverAgentId, custNumber, appAudioURL));
    }
